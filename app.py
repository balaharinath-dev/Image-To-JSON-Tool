        ...
        [
            SystemMessage(
                content=[
                    {
                        'type': 'text',
                        'text': 'You are an expert AI who summarizes from a given json data into paras and bullet points which is purely in context of medical science and also translates them into suitable language!'
                    }
                ]
            ),
            HumanMessage(
                content=[
                    {
                        'type': 'text',
                        'text': f'Summarize into paras and bullet points in medical context for the given json translated in {language}: \n {response}.'
                    }
                ]
            )
        ]
